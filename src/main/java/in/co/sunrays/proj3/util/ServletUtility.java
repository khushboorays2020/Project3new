...
public class ServletUtility {
    ...
    public static void setUserModel(UserModelInt model, HttpServletRequest request) {
    ...
    public static boolean isLoggedIn(HttpServletRequest request) {
        UserModelInt model = (UserModelInt) request.getSession().getAttribute("user");
        return model != null;
    }
    ...
    public static int getPageNo(HttpServletRequest request) {
        return Integer.parseInt((DataUtility.getStringData( request.getAttribute("pageNo"))));
    }
    ...
    public static int getPageSize(HttpServletRequest request) {
        return Integer.parseInt((DataUtility.getStringData( request.getAttribute("pageSize"))));
    }
