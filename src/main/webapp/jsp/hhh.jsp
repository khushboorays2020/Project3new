...
ul li a{
  ...
  <body>
	...
	%>
        ...
        <button  <%if(userLoggedIn){ %>style="margin-left:285px;"<%}else{%>style="margin-right:170px"<%} %> class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
          
          <span class="navbar-toggler-icon"></span>
        </button>
        <img align="right" alt="" src="/pro3/image/sunn.jpg" width="120px"
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="<%=ORSView.WELCOME_CTL%>" style="color: black;"><i class="fa fa-home fa-1x" aria-hidden="true" size="30"></i></a>
            </li>
