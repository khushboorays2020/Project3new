...
<jsp:useBean id="dto2" class="in.co.sunrays.proj3.dto.RoleDTO" scope="request"></jsp:useBean>
 ...
 <%List l=ServletUtility.getList(request); %>
   ...
   <div class="col-sm-2">
    ...
    <div class="col-sm-2"> 
    <button type="submit" value="<%=UserListCtl.OP_SAVE%>" class="btn btn-dark" style="margin-top: 25px;"><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Search</button>
 
    <button type="submit" value="<%=UserListCtl.OP_RESET%>" class="btn btn-dark" style="margin-top: 25px;"><i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;Reset</button>
 </div>
 <div class="col-sm-3"></div>
   </div>
   <br>
      ...
      <tr class="info">
         <td><input type="checkbox" class="checkbox" name="ids" value="<%=dto1.getId()%>" <%if (dto1.getRoleId() == 1) {%>
                    ...
                    <td align="center"><%=dto1.getRoleName()%></td>
                      ...
                      <td align="center"><%=dto1.getDob()%></td>
                     <%if(userBean1.getRoleId()==4 ||userBean1.getRoleId()==3 ||userBean1.getRoleId()==2){ %>
