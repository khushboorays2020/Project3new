...
$(function() {
	...
	$('[name="ids"]').click(function () {if(!($(this)[0].checked)){
...
ul li a{
   ...
   <nav class="navbar  fixed-top navbar-expand-sm bg-danger  navbar-light ">
 ...
 <img align="left" alt="" src="/Project3/img/sunn.jpg" width="120px" height="40px">
       ...
       <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
         ...
         &nbsp;<ul class="navbar-nav mt-2 mt-lg-0 ">
          ...
          <li class="nav-item dropdown dmenu">
            ...
            <div class="dropdown-menu sm-menu">
              ...
              <a class="dropdown-item" href="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>" target="blank"><i class="fa fa-server"></i>Marksheet merit list</a>
         ...
         <%--  <li class="nav-item dropdown dmenu">
          ...
          <%}} %>
           ...
           <li class="nav-item dropdown dmenu">
           <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
           <i class="fa fa-user-circle" style="color:white"></i><span style="color: white;"><%=welcomeMsg%>
           </span> </a>
           <div class="dropdown-menu sm-menu">
            
             <%if(userLoggedIn){ %>
             <a class="dropdown-item" href="<%=ORSView.MY_PROFILE_CTL%>"><i class='fas fa-caret-square-right' style="color:" ></i>My profile</a>
             <a class="dropdown-item" href="<%=ORSView.CHANGE_PASSWORD_CTL%>"><i class='fas fa-cogs fa-spin' style="color:" ></i>Change password</a> 
              <a class="dropdown-item" href="<%=ORSView.JAVA_DOC_VIEW%>" target="blank"><i class='fas fa-file-excel' style="color:" ></i>Java doc</a>
