...
<body background="/pro3/image/abc.png">
		...
		<div class="container-fluid" align="center" style="margin-top: 100px;">
			...
			<aside class="col-sm-4">
				...
				<div class="card" align="center"
					style="border: 4px solid black; width:"><a>
					...
					<!-- <div class="card-header">dgddg</div>
					 -->
					...
					<article class="card-body">
						...
						<h4 class="card-title text-center mb-4 mt-1"
							style="color:  black;">Update user</h4>
						...
						<div class="card-header"><h4 class="card-title text-center mb-4 mt-1"
							style="color: black;">Add user</h4></div>
						<%
							}
						%>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><%=ServletUtility.getErrorMessage("confirmPassword", request)%></font>
							</div>
						</div>
 ...
 --%>
						...
						<div class="form-group">
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"> <i class="fas fa-male"></i>
									</span>
								</div>

								<%--  <input type="text" name="role" class="form-control" placeholder="LoginId" value="<%=DataUtility.getStringData(dto.getLogin())%>">
	 --%>

								<%=HTMLUtility.getList("roleId", String.valueOf(dto.getRoleId()), l)%>
							</div>
							<div align="left">
								<font style="color: red"><%=ServletUtility.getErrorMessage("role", request)%></font>
							</div>
						...
						<button type="submit" name="operation"
							style="float: left; width: 80px; margin-left: 50px;" value="<%=UserCtl.OP_UPDATE%>"
							class="btn btn-primary btn-block button2 msgBtn">Update
						</button>
						...
						<button type="submit" name="operation"
							...
							class="btn btn-primary btn-block button2">Cancle</button>
						...
						<button type="submit" name="operation"
							style="float: left; width: 80px; margin-left: 50px;" value="<%=UserCtl.OP_SAVE%>"
							class="btn btn-primary btn-block button2 msgBtn">
							Submit</button>
						...
						<button type="submit" name="operation"
							...
							class="btn btn-primary btn-block button2">Reset</button>
