...
public class StudentModelHibImpl implements StudentModelInt {
    ...
    public StudentDTO findByEmailId(String emailll) throws ApplicationException {
        ...
        try {
            ...
            criteria.add(Restrictions.eq("email", emailll));
    ...
    public void update(StudentDTO dto) throws ApplicationException,
        ...
        CollegeDTO cobean=model1.findByPK(dto.getCollegeId());
       dto.setCollegeName(cobean.getName());
    ...
    public List search(StudentDTO dto, int pageNo, int pageSize)
        ...
        log.debug("Student Model search Started");
        System.out.println("student search hib impl run");
        Session session = null;
        List list = null;
        try {
            session = HibDataSource.getSession();
