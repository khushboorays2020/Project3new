...
public class CollegeModelHibImpl implements CollegeModelInt {
     ...
     *
     * @param dto : get 
     * @throws ApplicationException: application not found
     * @throws DuplicateRecordException: duplicate record 
     *
     */
     ...
     *
     * @param dto : get data
     * @throws ApplicationException: record not found
     */
     ...
     * @throws ApplicationException: record not found
     * * @throws             DuplicateRecordExceptionn:  duplicate record not found
     */
