...
<%if(ServletUtility.getSuccessMessage(request) !=null && ServletUtility.getSuccessMessage(request).length()>0 ){ %>
 ...
 <div class="col-sm-2">
  ...
  <input type="text" class="form-control" id="email" placeholder="first name" name="firstName">
   ...
   <div class="col-sm-2">
    ...
    <div class="col-sm-2"> 
    <button type="submit" value="<%=UserListCtl.OP_SEARCH %>" class="btn btn-primary" style="margin-top: 25px;"><i class="fa fa-search fa-spin" aria-hidden="true"></i>&nbsp;Search</button>
 
    <button type="submit" value="<%=UserListCtl.OP_RESET %>" class="btn btn-primary" style="margin-top: 25px;"><i class="fa fa-refresh fa-spin" aria-hidden="true"></i>&nbsp;Reset</button>
 </div>
 <div class="col-sm-2"></div>
   </div>
   <br>
 ...
 <div class="table-responsive">
   ...
   <th style="color:black;" class="text-center">First Name.</th>
     <th style="color:black;" class="text-center">Last Name.</th>
     <th style="color:black;" class="text-center">gender.</th>
       <th style="color:black;" class="text-center">Date Of Birth.</th>
       <th style="color:black;" class="text-center">Mobi No.</th>
       <th style="color:black;" class="text-center">role ID.</th>
        <th style="color:black;" class="text-center">Email ID.</th>
    ...
    <tbody>
     <tr>
                    ...
                    <td align="center"><%=dto1.getRoleId()%></td>
...
<%if(list.size()==0){ %>
<button type="submit" name="operation" value="<%=UserListCtl.OP_BACK%>" class="next btn btn-primary" >Back </button></center>
 <%} %>
